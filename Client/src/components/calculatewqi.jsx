...
export default function CalculateWQI(params) {
  const [stateunderline, setstateunderline] = useState(true);
  return (
    <div className=" max-w-7xl mx-auto mt-24 mb-32 sm:mt-32 sm:mb-40 lg:mb-48 bg-white">
      ...
      <div className="mt-2.5">
        ...
        />
        <button className="rounded-md bg-gray-200 px-3.5 py-2 text-sm font-semibold text-black shadow-xs hover:bg-gray-300 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-500">
          Get started
        </button>
      </div>
